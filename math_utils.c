...
/*   Updated: 2024/07/08 09:42:01 by nbidal           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// this is basically a matrix sum
...
/* EXPLANATION
(x + yi)^2  -->  (x + yi) * (x + yi)  -->  x^2 + 2xyi + y^2i^2 on newline...
-->  x^2 + 2xyi + y^2(-1)  -->  x^2 + 2xyi - y^2
so we get a real part "x" = (x^2 - y^2) and an imaginary part "y" = (2xy)*/
